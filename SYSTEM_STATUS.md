...
## Can Answer
- 個人品牌目前的 cluster 分佈是什麼？哪個最弱？
- 最近發了哪些主題？有沒有重複？
- 品牌定位聲明是什麼（positioning statement）？
- 下一篇文章方向應該補哪個 cluster？
...
## Data Paths
- Index:  `G:/My Drive/AI Native PM/AI Native PM/90_AgentData/lpl_index.jsonl` (Obsidian)
- Brand:  `G:/My Drive/AISPMAgent/brand_context.json`
- Check:  `G:/My Drive/AISPMAgent/check.py`
- Add:    `G:/My Drive/AISPMAgent/add.py`
